...
User Function pedido()
    ...
    oBrowse:SetDescription('Pedidos de venda customizado')
...
Static Function MenuDef()
    ...
    ADD OPTION aRotina TITLE 'Incluir'      ACTION 'VIEWDEF.pedido' OPERATION MODEL_OPERATION_INSERT   ACCESS 0
    ADD OPTION aRotina TITLE 'Visualizar'   ACTION 'VIEWDEF.pedido' OPERATION MODEL_OPERATION_VIEW     ACCESS 0
    ADD OPTION aRotina TITLE 'Alterar'      ACTION 'VIEWDEF.pedido' OPERATION MODEL_OPERATION_UPDATE   ACCESS 0
    ADD OPTION aRotina TITLE 'Excluir'      ACTION 'VIEWDEF.pedido' OPERATION MODEL_OPERATION_DELETE   ACCESS 0
...
Static Function ModelDef()
    ...
    oModel:SetRelation('SC6_ITEM', {{'C6_FILIAL', 'xFilial("SC6")'}, {'C6_NUM', 'C5_NUM'}}, SC5->(IndexKey(1)))
